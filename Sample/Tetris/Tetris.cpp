...
void Tetris::KeyProcess()
{
	...
	for(int i=0; i<KeyNum; ++i)
	{
		if(keyin[i])
		{
			switch(i)
			{
			case 0: tetri->HardDrop(); break;
			case 1: break;//tetri.HardDrop(); break;
			case 2: tetri->SoftDrop(); break;
			case 3: tetri->Move(false); break;
			case 4: tetri->Move(true); break;
			case 5: tetri->Spin(false); break;
			case 6: tetri->Spin(true); break;
			case 7: Option(); break;
			case 8: break;
			case 9: break;
			}
